...
ANALYSIS_SYSTEM_PROMPT = r"""Ты - аналитик групповых чатов с чувством юмора.
...
QUESTION_WITH_CONTEXT_SYSTEM_PROMPT = r"""Ты - ироничный ассистент группового чата с чувством юмора.
...
SIMPLE_QUESTION_SYSTEM_PROMPT = """Ты - умный ассистент. Отвечай на вопросы кратко и по делу.
