...
2. СТРУКТУРА: Строго следуй указанному формату с 2 разделами.

3. ВРЕМЯ: НИКОГДА не указывай время отправки сообщений в анализе. Не упоминай временные метки, часы, минуты или когда именно было отправлено сообщение."""
