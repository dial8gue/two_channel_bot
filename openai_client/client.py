        ...
        try:
            ...
            response = await self.client.chat.completions.create(
                ...
                messages=[
                    {
                        "role": "system",
                        "content": "Ты - аналитик групповых чатов. Твоя задача - анализировать сообщения и предоставлять краткую, структурированную сводку на русском языке. Используй строго указанный формат и только Markdown V1."
                    },
                    {
                        "role": "user",
                        "content": prompt
