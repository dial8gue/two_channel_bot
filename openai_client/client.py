...
Используй сарказм, иронию и легкий цинизм. Будь кратким. Добавь эмодзи для драматического эффекта. Помни: мы анализируем человеческую комедию, а не пишем научную работу.
"""
        return prompt
