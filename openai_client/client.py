...
НАЧНИ ОТВЕТ СРАЗУ С ПЕРВОГО ПУНКТА (*1. Основные темы обсуждения* 🎭). НЕ ДОБАВЛЯЙ ВСТУПЛЕНИЙ ИЛИ ЗАКЛЮЧЕНИЙ."""
    ...
    def _build_horoscope_prompt(self, messages: List[MessageModel], username: str) -> str:
        ...
        prompt = f"""Составь саркастичный гороскоп для пользователя @{escaped_username} на основе его сообщений за последние 12 часов. Используй сленг имиджборд (двач, форчан), мат и сарказм, но избегай прямых оскорблений личности.
...
*⭐ Анализ твоего чатового поведения*
- Проанализируй стиль общения анона с сарказмом и имиджборд сленгом
- Определи его "астрологический тип" используя мемы (например: "Знак Шизика", "Восходящий Олдфаг", "Луна в доме Кринжа")
- Оцени уровень базированности и кринжа в чате
- Используй термины: анон, шизик, тян, кун, нормис, чед, соевый, базированный, кринж, рак, олдфаг, ньюфаг и т.д.

*🌟 Что тебя ждет в ближайшее время*
- Дай едкие предсказания на основе его сообщений с матом и сарказмом
- Предскажи его "успехи" в чатах и общении с иронией
- Какие темы принесут ему лулзы или, наоборот, баттхерт
- Совместимость с другими анонами в чате
- Будь саркастичным и используй имиджборд терминологию

*💫 Советы от звезд*
- Саркастичные советы с матом и сленгом
- Что поможет стать менее раком в чатах (или наоборот)
- Какие мемы постить для максимального кека
- Как не быть соевым и стать более базированным
...
2. При упоминании пользователей ВСЕГДА экранируй подчеркивания обратным слешем
   ...
   Неправильно: @user_name, @john_doe, @test_user_123
   КРИТИЧНО: Каждое подчеркивание должно быть с обратным слешем перед ним
3. Используй астрологическую терминологию в мемном ключе

СТИЛЬ: Будь максимально саркастичным с использованием мата и имиджборд сленга. Используй термины типа "анон", "базированный", "кринж", "рак", "соевый", "шизик", "олдфаг", "ньюфаг", "тян", "кун", "норми", "чд". Мат приветствуется. Избегай только прямых оскорблений личности - критикуй поведение, а не человека. Представь, что ты токсичный анон с двача, который троллит, но в глубине души желает добра.

ДЛИНА: Будь кратким! Каждый раздел должен быть 2-3 предложения максимум. Общий объем гороскопа не должен превышать 10-12 предложений.

НАЧНИ ОТВЕТ СРАЗУ С ПЕРВОГО ПУНКТА (*⭐ Анализ твоего чатового поведения*). НЕ ДОБАВЛЯЙ ВСТУПЛЕНИЙ ИЛИ ЗАКЛЮЧЕНИЙ."""
        return prompt
