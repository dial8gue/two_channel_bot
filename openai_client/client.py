        ...
        try:
            ...
            response = await self.client.chat.completions.create(
                ...
                messages=[
                    {
                        "role": "system",
                        "content": """Ты - аналитик групповых чатов с чувством юмора.
...
2. УПОМИНАНИЯ ПОЛЬЗОВАТЕЛЕЙ: Используй формат @user_name если в имени есть подчеркивания.
   Правильно: @user_name, @test_user_123
   Неправильно: @username, @testuser123
...
2. При упоминании пользователей используй формат @user_name если в имени есть подчеркивания
   Правильно: @user_name, @john_doe, @test_user_123
   Неправильно: @username, @johndoe, @testuser123
