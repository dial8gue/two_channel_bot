        ...
        try:
            ...
            response = await self.client.chat.completions.create(
                ...
                messages=[
                    {
                        "role": "system",
                        "content": "Ты - аналитик групповых чатов с чувством юмора. Ты СТРОГО следуешь указанному формату ответа. Используй Markdown для форматирования: *жирный текст* только для заголовков разделов. ПРИ УПОМИНАНИИ ПОЛЬЗОВАТЕЛЕЙ: Всегда используй формат @user_name, корректно отображая подчеркивания в именах."
                    },
                    {
                        "role": "user",
                        "content": prompt
